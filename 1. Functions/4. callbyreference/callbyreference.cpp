...
// 1. main a: 3, b: 4
// 2. swap a: , b: , temp: , return adrs: 5 <-- we evaluate places/links/positions, the local variables pass references to a and b in main
// 3. swap a: refs main's a = 3, b: refs main's b = 4, temp: , return adrs: 5
